...
public sealed class FrameworkDetection
{
    ...
    [
        ...
        ("Microsoft.Orleans.Server", ("orleans", "Microsoft Orleans")),
        ("Microsoft.Orleans.Core", ("orleans", "Microsoft Orleans")),
        ("Microsoft.Orleans.Sdk", ("orleans", "Microsoft Orleans")),
    ...
    [
        ...
        ("Azure.Messaging.ServiceBus", ("messaging", "Azure Service Bus")),
        ("RabbitMQ.Client", ("messaging", "RabbitMQ")),
        ("Orleans", ("orleans", "Microsoft Orleans")),

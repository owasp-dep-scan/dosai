...
| grpc-dotnet `Grpc.Net.Client` | `grpc-dotnet/src/Grpc.Net.Client` | A real six-target multi-targeting library (`net462;netstandard2.0;netstandard2.1;net8.0;net9.0;net10.0`): union of preprocessor guards analyzed, full TFM set surfaced |

...
namespace Analyzer.Utilities.FlowAnalysis.Analysis.TaintedDataAnalysis
{
    ...
    public partial class TaintedDataAnalysis : ForwardDataFlowAnalysis<TaintedDataAnalysisData, TaintedDataAnalysisContext, TaintedDataAnalysisResult, TaintedDataBlockAnalysisResult, TaintedDataAbstractValue>
    {
        ...
        private static TaintedDataAnalysisResult? TryGetOrComputeResultForAnalysisContext(TaintedDataAnalysisContext analysisContext)
        {
            ...
            TaintedDataAnalysis analysis = new(analysisDomain, visitor);

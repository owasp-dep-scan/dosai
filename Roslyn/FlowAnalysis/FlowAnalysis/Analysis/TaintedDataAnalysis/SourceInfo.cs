...
{
    public delegate bool PointsToCheck(ImmutableArray<PointsToAbstractValue> pointsTos);
    public delegate bool ValueContentCheck(ImmutableArray<PointsToAbstractValue> pointsTos, ImmutableArray<ValueContentAbstractValue> valueContents);
    public delegate bool MethodMatcher(string methodName, ImmutableArray<IArgumentOperation> arguments);
    public delegate bool ParameterMatcher(IParameterSymbol parameter, WellKnownTypeProvider wellKnownTypeProvider);
    public delegate bool ArrayLengthMatcher(int length);

    /// <summary>
    /// Info for tainted data sources, which generate tainted data.
    /// </summary>
    public sealed class SourceInfo : ITaintedDataInfo, IEquatable<SourceInfo>
    {
        /// <summary>
        /// Constructs.
        /// </summary>
